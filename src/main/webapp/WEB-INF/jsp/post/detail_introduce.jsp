...
<div id="detailIntroduce">
	...
	<div class="w50">
		...
		<div class="houseInfoArea">
			<div class="houseInfo" id="type">${post.type}</div>
			<div class="line"></div>
			<div class="houseInfo" id="area">${post.area}평</div>
			<div class="line"></div>
			<div class="houseInfo" id="familyType">${post.familyType}</div>
			<div class="line"></div>
			<div class="houseInfo" id="fieldOfWork">${post.fieldOfWork}</div>
			<div class="line"></div>
			<div class="houseInfo" id="worker">${post.worker}</div>
		</div>
