...
<div id="gnb" class="d-flex align-items-center h-100">
	...
	<nav class="h-100">
		<ul id="mainMenu" class="nav">
			<li class="nav-item"><a href="/community/photo_view" class="nav-link blue d-block">사진</a></li>
			<li class="nav-item"><a href="/community/introduce_view" class="nav-link blue d-block">집들이</a></li>
			<li class="nav-item"><a href="/community/knowhow_view" class="nav-link blue d-block">노하우</a></li>
		</ul>
	</nav>
...
$(document).ready(function() {
	...
	$('#keyword').on("keyup",function(key){
        if(key.keyCode==13) {
			...
			location.href = "/community/search?keyword=" + keyword;
        }
    });
